	...
	Slider.prototype = {
		init: function() {
			...
			if(this.showMarkers) {
				...
				{
					this.obj.getElementsByTagName('ol')[0].getElementsByTagName('li')[i].style.width = this.obj.getElementsByTagName('ol')[0].clientWidth/aLis.length-1+"px";
