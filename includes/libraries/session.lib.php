 ...
 * PaiLa: SESSION 公用类库
 * ============================================================================
 * 版权所有 (C) 2010-2011 上海商派网络科技有限公司，并保留所有权利。
...
class SessionProcessor
{
    ...
    var $max_life_time  = 14400; // SESSION 过期时间
     ...
     * @return void
     */
    function __construct(&$db, $session_table, $session_data_table, $session_name = 'PL_ID', $session_id = '')
    {
     ...
     * @return void
     */
    function SessionProcessor(&$db, $session_table, $session_data_table, $session_name = 'PL_ID', $session_id = '')
    {
    ...
    function _sess_write($sesskey, $sessvalue)
    {
        ...
        {
            $this->db->query("REPLACE INTO `pa_sessions_data` SET sesskey = '{$this->session_id}', expiry={$expiry}, data='{$sessvalue}'");
            $is_overflow = 1;
            $sessvalue = '';
        }
