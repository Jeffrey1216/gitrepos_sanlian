...
class My_shippingApp extends StoreadminbaseApp
{
    function index()
    {
        ...
        $this->display('storeadmin.myshipping.index.html');
    }
    ...
    function drop()
    {
        ...
        {
            /* 没有可删除的项 */
            $this->show_storeadmin_warning('no_such_shipping');
        ...
        {
            $this->show_storeadmin_warning($model_shipping->get_error());

            return;
        }

        $this->show_storeadmin_message('drop_shipping_successed');
    }
