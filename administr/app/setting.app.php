    ...
    function base_setting()
    {
        ...
        if ($feed_enabled)
        {
            $_feed_list = array(
            	...
            	'image_url'		   => Lang::get('feed_image_url'),	
            );
        }
        if (!IS_POST)
        {
...
//            $data['captcha_error_login']    = $_POST['captcha_error_login'];
    ...
    function store_setting()
    {
        ...
        else
        {
            ...
            $data['own_store']			= intval($_POST['own_store']);
            $data['channel_id']  		= intval($_POST['channel_id']);
            $data['need_mobile']      = trim($_POST['need_mobile']);
            $data['achievement']        = $_POST['achievement'];
            $data['channel_verify_mobile']    = $_POST['channel_verify_mobile'];
            $data['fi_verify_mobile']    = $_POST['fi_verify_mobile'];
            $model_setting->setAll($data);
