<?php
class Paila_shopWidget extends BaseWidget {
	
	public $_name = 'paila_shop';
	public function _get_data() {
        ...
        if ($data === false)
        {
        	...
        	$paila_shop = $widget_mod->get(array('conditions' => "widget_name = '".$this->_name."'"));
        	$paila_shop_data = $paila_shop['widget_data'];
        	$data = unserialize($paila_shop_data);
...
//        	
			$data['left'][] = $data['images'][0];
			$data['left'][] = $data['images'][1];
			$data['left'][] = $data['images'][2];

			$data['right'][] = $data['images'][3];
			$data['right'][] = $data['images'][4];
			$data['right'][] = $data['images'][5];
			
			$data['between'][] = $data['images'][6];
			$data['between'][] = $data['images'][7];
			$data['between'][] = $data['images'][8];
