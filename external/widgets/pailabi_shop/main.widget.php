<?php
class Pailabi_shopWidget extends BaseWidget {
	
	public $_name = 'pailabi_shop';
	...
	public function _get_data() {
        ...
        if ($data === false)
        {
        	...
        	$pailabi_shop = $widget_mod->get(array('conditions' => "widget_name = '".$this->_name."'"));
        	$pailabi_shop_data = $pailabi_shop['widget_data'];
        	$data = unserialize($pailabi_shop_data);
